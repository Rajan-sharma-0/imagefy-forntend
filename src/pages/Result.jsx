...
function Result() {
  ...
  const {gernateImage} = useContext(AppContext);
...
{!isImageLoading &&     <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm p-0.5 mt-10 rounded-full'>
...
{isImageLoading &&
    ...
    <div className="flex gap-2 flex-wrap justify-center text-white text-sm p-0.5 mt-10 rounded-full">
      <p onClick={()=>{setIsImageLoading(false)}} className="bg-transparent border border-zinc-900 text-black px-8 py-3 rounded-full cursor-pointer">Gernate Another</p>
